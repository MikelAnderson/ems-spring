...
@CrossOrigin("*") //desde que origenes se permite conectar con la aplicacion de front-end o poner otro puerto
@RestController //
@RequestMapping("/api/employees")
public class EmployeeController {
    @Autowired
    private EmployeeService employeeService; //Se usa el service nunca el repository
